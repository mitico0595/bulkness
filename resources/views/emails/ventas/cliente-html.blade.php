...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .note{background:#f9f9f9;padding:18px;border-left:3px solid #8b7b00ff;margin-top:32px;font-size:12.5px;color:#666;}
...
<div class="email-container">
    <div class="header">
        <div class="logo"><span>A</span>migurumis.pe</div>
    </div>
    <div class="content">
        ...
        <div class="client-info">
            ...
            @else
                <div class="client-detail"><strong>Recojo:</strong> coordina al WhatsApp {{ $whatsapp }} indicando tu código.</div>
            @endif
        </div>
        ...
        <div class="note">
            Si tienes dudas escríbenos al WhatsApp {{ $whatsapp }}.
        </div>
    </div>
    <div class="footer">
        <div class="footer-title">Adler • Mochilas de emergencia</div>
        <div class="social-links" style="text-align:center;display:block">
            <a href="{{ env('MAIL_WHATSAPP_URL', '#') }}">WhatsApp - </a>
            <a href="{{ env('MAIL_INSTAGRAM_URL', '#') }}">- Instagram - </a>
            <a href="{{ env('MAIL_FACEBOOK_URL', '#') }}">- Facebook</a>
        </div>
        <div class="footer-text">{{ date('Y') }} Adler. Gracias por tu compra. <a href="https://adler.pe/terminos/garantia">Términos y condiciones</a></div>
    </div>
</div>
</body>
</html>
