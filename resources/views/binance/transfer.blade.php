...
<form action="{{route('crypto/transfer')}}" method="post" id="checkout-form" >
...
<div style="min-width:850px;max-width:850px; box-sizing:border-box; padding:20px 20px 30px; width: 100%; position: relative;display: inline-block;margin:0px;margin-top: 20px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca;float:left" id="clicka" >
    ...
    <div style="position: relative;width:100%;margin-top:20px">
        <a href="{{url('crypto/checkout')}}"><div class="envio done" style="">
        ...
        <a href="{{url('crypto/checkoutcity')}}"><div class="envio done" style="margin-left:10px">
...
<div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;">
            ...
            <select  name="distrito" id="distrito"  class="inputn" value="{{ Auth::user()->distrito}}" required>
                <option value="">Distrito</option>
            </select>
        </div>
        <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
            <label for="provincia" class="labelt" style="">Provincia</label>
            <select  name="provincia" id="provincia"  onchange="cambiaDistrito()" class="inputn" value="{{ Auth::user()->provincia}}" required placeholder="Provincia" required>
        ...
        <a href="{{url('busco')}} " style="position:relative;display:inline-block;float:left"><div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-top: 20px; box-sizing: border-box; color:#ba1f1f;
        ...
        {{ csrf_field() }}
               <button type="submit" style="justify-content:center; font-weight:100;text-align:center;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;width:535px;border-radius:5px;border:none;background:#000;padding:10px 0px;color:white;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;cursor:pointer;display:flex;position:relative;float:left;" ><img src="{{asset('image/binance.png')}} " alt="" style="width:30px"> <span style="line-height:30px;width:150px;">Pagar | Binance Pay</span> </button>
    ...
    <div id="target">
         ...
         <!--  <h2 style="margin:0px;padding-top: 10px;font-size: 20px;font-weight: 100;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">Criptomoneda</h2>
        <div style="position: relative;width:100%;margin-top:20px;display:inline-block;margin-bottom:15px;">
            <div style="width: 320px;">


            <div class="envio" style="">
                Criptomoneda<img src="{{asset('image/svg/tarjeta-de-credito.svg')}} " style="width:30px;position: absolute;right: 20px;top:10px;">
            </div>
            <a href="{{url('transfer')}} "><div class="envio done" style="margin-top:10px;">
                Realizar pedido <img src="{{asset('image/svg/tarjeta-de-credito.svg')}} " style="width:30px;position: absolute;right: 20px;top:10px;">
            </div>
            </a>
            </div>
        </div>
...
<div style="margin-left:20px; box-sizing:border-box;width: 330px; position: relative;display: inline-block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;margin-top:20px;height:100px;" >
    ...
    <div style="position: absolute;right: 0px; display: block;box-sizing:border-box; width:330px;top:-20px;padding:30px;border:1px solid #cecece;padding-top: 20px;border-radius: 7px;margin-top: 20px;background: #282828;display: block;min-height:457px;" id="todo">
        ...
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 20px;">
            ...
            <div style="position: absolute;top:65px;left:135px;width: 150px;color:#fff;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align: center;width: 50px;font-size: 10px">{{number_format($search['item']['precio']/$tc,2)}} </div>
            <input type="number" name="precio_venta[]" value="{{$search['item']['precio'] }}" style="display: none;" >
            <div style="position: absolute;top:80px;left:120px;width: 150px;color:#fff;text-align: center;width: 150px;font-size: 11px;font-weight: 100;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif">SUB-TOTAL USDT  {{number_format($search['precio']/$tc,2)}} </div>
        ...
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 20px;padding-bottom: 0">
            ...
            <h1 style="position: relative;width: 80px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px;margin: 0 ">USDT  {{number_format($totalp,2)}} </h1>
        </div>
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 0px;padding-top: 0;padding-bottom: 0 ">
            <h1 style="position: relative;width: 180px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px; margin: 0">Cargos Logisticos (0,00%): </h1>
            <h1 style="position: relative;width: 80px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px; margin: 0">Sin cargos   </h1>
        </div>
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 0px;padding-top: 0;border-bottom: 1px solid #808080;box-sizing: border-box;">
            <h1 style="position: relative;width: 180px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px; margin: 0">Envio: </h1>
            <h1 style="position: relative;width: 50px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px; margin: 0">Sin Paga </h1>
        </div>
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 10px;padding-top: 0;border-bottom: 1px solid #808080;box-sizing: border-box;">
            ...
            <h1 style="position: relative;width: 100%;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 15px; margin: 0;text-align:center">USDT {{number_format($total,2)}}</h1>
        </div>
    </div>
...
<script>
    const formul = document.querySelector('#card-number');
    formul.addEventListener('keyup', (e)=> {
        let valorInput = e.target.value;
        formul.value = valorInput
