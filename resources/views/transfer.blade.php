...
<div style="box-sizing:border-box;width: 100%; position: relative;display: inline-block;margin:0px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;margin-top:150px;height:100px;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca" >
    <img src="{{asset('image/thumb/cart-p5.png ')}}" alt="" style="width:530px" id="imgsen">
...
<form action="{{route('transfer')}}" method="post" id="checkout-form" >

<div style="min-width:850px;max-width:850px; box-sizing:border-box; padding:20px 20px 30px; width: 100%; position: relative;display: inline-block;margin:0px;margin-top: 20px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca;float:left" id="clicka" >
    ...
    <div style="position: relative;width:100%;margin-top:20px">
        <div class="envio" style="">
            Realizar Pedido <img src="{{asset('image/svg/pedidos.svg')}} " style="width:30px;position: absolute;right: 20px;top:10px;">
        </div>
    ...
    <div style="position: relative;display:inline-block;width:100%;max-width:1000px;min-width:900px;">
        ...
        <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
         ...
         <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;">
            ...
            <select  name="distrito" id="distrito" required="" class="inputn" value="{{ Auth::user()->distrito}}">
                <option>Distrito</option>
            </select>
        </div>
        <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
            <label for="provincia" class="labelt" style="">Provincia</label>
            <select  name="provincia" id="provincia" required="" onchange="cambiaDistrito()" class="inputn" value="{{ Auth::user()->provincia}}" required placeholder="Provincia">
                <option>Provincia</option>
            </select>
        </div>
        <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
            <label for="ciudad" class="labelt" style="">Ciudad</label>
            <select style="" name="ciudad" id="ciudad" for="ciudad" class="inputn" onchange="cambia()" required="">
        ...
        <div style="width:535px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-top: 20px; box-sizing: border-box; background:#ba1f1f;color:white;
        line-height: 40px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:center;font-weight:100;margin-left:10px;border-radius:5px;cursor:pointer;" onclick="targetinfo()">
    ...
    <div style=";min-width:850px;max-width:850px; box-sizing:border-box; padding:20px 20px 30px; width: 100%; position: relative;margin:0px;margin-top: 20px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca;float:left" id="posstarget">
    <div id="target">
        <section class="tarjeta" id="tarjeta" style="position:absolute;right: 60px;max-width: 250px;">

			<div class="delantera" style="background:#282828">
				<div class="logo-marca" id="logo-marca" style="position: absolute;right: -20px; top: 10px;width: 50px;">
					<!-- <img src="img/logos/visa.png" alt=""> -->
				</div>
				<img src="{{asset('image/thumb/chip-tarjeta.png')}}" class="chip" alt="">
				<div class="datos">
					<div class="grupo" id="numero" style="margin: 0;">
						<p class="label">Código de cliente</p>
						<p class="numero">021 25{{ Auth::user()->id}}</p>
					</div>
					<div class="flexbox">
						<div class="grupo" id="nombre">
							<p class="label">Nombre Titular</p>
							<p class="nombre">{{Auth::user()->name}} {{Auth::user()->lastname}}</p>
						</div>
			...
			<div class="trasera" style="width:100%;height: 152px;">
				<div class="barra-magnetica"></div>
				<div class="datos">
					<div class="grupo" id="firma">
						<p class="label">Firma</p>
						<div class="firma" ><p style="font-family: 'Fuggles', cursive;"></p></div>
					</div>
        ...
        <h2 style="margin:0px;padding-top: 10px;font-size: 20px;font-weight: 100;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">Solicitud de Pedido</h2>
        <div style="position: relative;width:100%;margin-top:20px;display:inline-block;margin-bottom:15px;">
            <div style="width: 320px;">


            <div class="envio" style="">
                Realizar transferencia <img src="{{asset('image/svg/transferencia.svg')}} " style="width:30px;position: absolute;right: 20px;top:10px;">
            </div>
            <a href="{{url('checkout')}} "><div class="envio done" style="margin-top:10px;">
                Crédito/ Débito <img src="{{asset('image/svg/tarjeta-de-credito.svg')}} " style="width:30px;position: absolute;right: 20px;top:10px;">
            </div>
            </a>
            </div>
        </div>
        <div>
            <h5 style="margin: 0;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">1. Comuniquese por Whatsapp: (+51) 983 814 992 </h5>
            <h5 style="margin: 0;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">y envíe el siguiente mensaje: Obtener cuentas OBERLU. </h5>
            <h5 style="margin: 0;margin-top:8px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">2. Inserte Nombre y apellido del titular de la cuenta origen a transferir.</h5>
            <h5 style="margin: 0;margin-top:8px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">3. Consultar por Whatsapp costos de envío.</h5>
            <h5 style="margin: 0;margin-top:8px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">4. Envíe Foto Voucher o Screenshoot al Whatsapp.</h5>
            <h5 style="margin: 0;margin-top:8px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;color:red">ATENCION: Si realiza mas de 3 solicitudes sin realizar transferencias el sistema automáticamente bloqueará la cuenta. </h5>

        </div>

        <div style="position: relative;display:inline-block;width:100%;max-width:1000px;min-width:900px;">
            <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;">
                <label for="" class="labelt" style="">Numero de Soporte</label>
                <input type="text" name="" id="" required="" class="inputn"  maxlength="19" value="Soporte Whatsapp: 983 814 992" disabled style="border:none">
            </div>
            <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
                <label for="card-name" class="labelt" style="">Nombres</label>
                <input type="text" name="card-name" id="card-name" required="" class="inputn" value="{{Auth::user()->name}} " maxlength="12">
            </div>
            <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-left:10px">
                <label for="card-lastname" class="labelt" style="">Apellidos</label>
                <input type="text" name="card-lastname" id="card-lastname" required="" class="inputn" value="{{Auth::user()->lastname}} " placeholder="Ej. Lombardi">
            </div>



            <div style="width:260px;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;margin-top: 20px; box-sizing: border-box; color:#ba1f1f;
            line-height: 40px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:center;font-weight:600;cursor:pointer" onclick="modify()">
                Modificar datos de envío
            </div>
            {{ csrf_field() }}
               <button type="submit" style="font-weight:100;text-align:center;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;width:535px;border-radius:5px;border:none;background:#ba1f1f;padding:10px 0px;color:white;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;cursor:pointer;" >Realizar Pedido | S/. {{number_format($total,2)}}</button>
...
<div style="margin-left:20px; box-sizing:border-box;width: 330px; position: relative;display: inline-block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;margin-top:20px;height:100px;" >
    ...
    <div style="position: absolute;right: 0px; display: block;box-sizing:border-box; width:330px;top:-20px;padding:30px;border:1px solid #cecece;padding-top: 20px;border-radius: 7px;margin-top: 20px;background: #282828;display: block;min-height:457px;" id="todo">
        ...
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 0px;padding-top: 0;padding-bottom: 0 ">
            <h1 style="position: relative;width: 180px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px; margin: 0">Cargos Logisticos (0%): </h1>
...
<script type="text/javascript">
    if ("geolocation" in navigator){ //check geolocation available
        ...
        navigator.geolocation.getCurrentPosition(function(position){
                document.getElementById("idlat").value = position.coords.latitude;
                document.getElementById("idlon").value = position.coords.longitude;
    ...
    function get_ip(obj){
                document.getElementById('ipcon').value = obj.ip;
       }
