...
<div style="min-width:850px;max-width:850px; box-sizing:border-box; padding:20px 20px 30px; width: 100%; position: relative;display: inline-block;margin:0px;margin-top: 20px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca;float:left" id="clicka" >
    ...
    <div style="position: relative;width:100%;margin-top:20px">
        ...
        <a href="{{url('checkoutcity')}}"><div class="envio done" style="margin-left:10px">
    ...
    <div style="position: relative;display:inline-block;width:100%;max-width:1000px;min-width:900px;">
        ...
        {{ csrf_field() }}
               <button type="submit" style="font-weight:100;text-align:center;position: relative;display: inline-block;margin-top: 20px;box-sizing:border-box;width:535px;border-radius:5px;border:none;background:#ba1f1f;padding:10px 0px;color:white;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;cursor:pointer;" >Guardar y Continuar</button>
...
<div style="margin-left:20px; box-sizing:border-box;width: 330px; position: relative;display: inline-block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;margin-top:20px;height:100px;" >
    ...
    <div style="position: absolute;right: 0px; display: block;box-sizing:border-box; width:330px;top:-20px;padding:30px;border:1px solid #cecece;padding-top: 20px;border-radius: 7px;margin-top: 20px;background: #282828;display: block;min-height:457px;" id="todo">
        ...
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 20px;padding-bottom: 0">
            ...
            <h1 style="position: relative;width: 80px;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:#cecece;font-size: 12px;margin: 0 ">S/.  {{number_format($total,2)}} </h1>
        </div>
