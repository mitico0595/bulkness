...
<div style="position:relative; min-width:850px;max-width:850px; box-sizing:border-box; padding:20px 20px 30px; width: 100%; position: relative;display: inline-block;margin:0px;margin-top: 20px;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;float:left" id="clicka" >
    ...
    <div style="position: relative;width:100%;margin-top:20px">
        <a href="/detail/{{$venta->idventa}} "><div class="envio done" style="">
...
<div style="margin-left:20px; box-sizing:border-box;width: 330px; position: relative;display: inline-block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border:none;margin-top:20px;height:100px;" >
    ...
    <div style="position: absolute;right: 0px; display: block;box-sizing:border-box; width:330px;top:-20px;padding:30px;border:1px solid #cecece;padding-top: 20px;border-radius: 7px;margin-top: 20px;background: white;display: block;border: 1px solid #cacaca;border-radius:5px;box-shadow:1px 1px 4px #cacaca" id="todo">
        ...
        <div style="position: absolute;top:20px;font-size: 12px;color:#282828"> DETALLE DE COMPRA</div>
        ...
        <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 20px;">
            <div style="width: 90px; position: relative;float:left;display: block;"><img src="{{asset('images/'.$det->image )}} " style="width:100%;border-radius: 50px;"></div>
            <div style="position: absolute;top:10px;left:110px;width: 150px;font-size: 15px;line-height: 15px;color:#282828;letter-spacing: 0;line-height: 15px;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden; margin: 0px;">{{ $det->articulo}}</div>
            <div style="position: absolute;top:50px;left:110px;width: 150px;font-size: 10px;line-height: 10px;color:#282828;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif ">{{$det->code }}</div>
            <input type="number" name="idarticulo[]" value="" style="display: none;color:#282828" >
            <div style="position: absolute;top:65px;left:110px;color:#282828;font-size: 10px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif">x{{ $det->cantidad}} </div>

            <div style="position: absolute;top:65px;left:135px;width: 150px;color:#282828;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align: center;width: 50px;font-size: 10px">{{ $det->precio_venta}} </div>

            <div style="position: absolute;top:80px;left:120px;width: 150px;color:#282828;text-align: center;width: 150px;font-size: 11px;font-weight: 100;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif">SUB-TOTAL  S/. {{ $venta->total_parcial }}</div>
        ...
        @endif
             ...
             <div style="width: 100%;padding:10px;position: relative;display: inline-block;margin: 0px;margin-top: 10px;padding-top: 0;border-bottom: 1px solid #808080;box-sizing: border-box;">
                ...
                <h1 style="position: relative;width: 100%;float: left;display: block;font-family:Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight:100;color:black;font-size: 15px; margin: 0;text-align:center">S/. {{number_format($venta->total_venta,2)  }}</h1>
            </div>
    </div>
