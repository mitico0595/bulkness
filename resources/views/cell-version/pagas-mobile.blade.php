...
<body>
    ...
    <form action="{{url('pav-mobile')}}" method="post" id="checkout-form" style="">
        @csrf
    <div class="address-content">
        ...
        <div class="address-modify">
            ...
            <input type="" name="distrito" value="{{ Auth::user()->distrito}}" style="text-transform:uppercase;border:none;width: 80%;color:#808080;text-transform: uppercase;font-size: 10px;" readonly id="disto">
            <input type="" name="provincia" value="{{ Auth::user()->provincia}}," style="text-transform:uppercase; border:none;width: 80%;color:#808080;text-transform: uppercase;font-size: 10px;display: block;position: relative;float: left;" readonly id="provo"> 
            <input type="" name="ciudad" value=" {{ Auth::user()->ciudad}}" style="text-transform:uppercase;border:none;width: 80%;color:#000;text-transform: uppercase;font-size: 12px;display: block;position: relative;float: left;margin-left: -2px;margin-top:8px; font-weight: bold;" readonly id="ciuo">
