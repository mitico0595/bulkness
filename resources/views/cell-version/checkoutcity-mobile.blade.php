...
<body>
    ...
    <div class="address-content" style="margin-top:0px;margin-bottom:60px;">
        ...
        <form id="frmVisaNet" method="post" action="{{url('/finalizarmobile',["purchaseNumber" => $purchaseNumber, "amount" => $amount]) }}"  >               
    ...
    <div style="position: fixed; bottom:0px;width: 100%;background: white;height: 50px;">
        ...
        {{ csrf_field() }}
        <a href="{{asset('pagas-mobile')}} " style="position:absolute; padding: 5px 10px; width: 200px;background: #b10000;color:white;right: 15px;top:10px;font-family: 'Kanit';text-align: center; " >
            Modificar Domicilio
        </a>
    </div>
