    ...
    <div style="position: relative; width:100%;margin:auto;display:block;background:white;box-shadow: 0 1px 2px 0 rgb(0 0 0 / 12%);margin-bottom:70px;">
        ...
        <div style="width:100%;display:block;background:white;position: relative;margin-bottom:20px;padding:0px 20px;border-top: 4px solid #eee;display:inline-block;">
            ...
            <div style="width:100%;display:block;background:white;position: relative;margin-bottom:20px;padding:0px 20px;display:inline-block;" >
                ...
                <h5 style="font-family: sans-serif;font-size:15px;font-weight:100;margin-bottom:20px;color:#848484">Direcciones: Clic apertura google maps</h5>
                <div style="display: flex;flex-direction:column">
                    <a href="https://goo.gl/maps/1iiw2KSJPCdZgZqq8" style="text-decoration: none"><h5 style="font-family: sans-serif;font-size:15px;font-weight:100;margin:0">Calle Margarita Praxedes 120 Of. 301, San Miguel.</h5></a>
                    <a href="https://goo.gl/maps/Wb2YAfteEA8LerjG6" style="text-decoration: none;color:purple"><h5 style="font-family: sans-serif;font-size:15px;font-weight:100;margin:0">Jr. Cusco 626 Stand 305 (G. Mercado Central), Cercado de Lima.</h5></a>
                </div>
