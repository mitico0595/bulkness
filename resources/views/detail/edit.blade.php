...
@section ('usuario-cont')
 ...
 <div style="background-color: #eaeaea;position: relative;width: 40%;min-width:400px; margin: auto;display: block;padding-top: 170px;">
		...
		<div class="" style="position: relative;width: 100%; background: #000;padding: 10px;height: 40px">
			...
			{!!Form::model($detalles,['method'=>'PATCH','route'=>['detail.update',$detalles->id_dventa]])!!}
			{{Form::token()}}
		<div class="" style="position: relative;padding: 5px;width:100%;position: relative;margin:auto;background: #fff;padding: 20px; ">
			<div style="position: relative;">
				...
				<div style="width: 80%;position: relative;display: block;margin:auto;height: 50px;">
					<div style="position: relative;margin: auto;display: block;width: 150px;">
					...
					<div style="position: relative;display: inline-block;padding: 10px;font-size: 15px;font-family:'Kanit';float: left;text-align: center;border-radius: 10px;background: #a305fa;color:#fff; margin-left: 5px; ">S/. {{$detalles->precio_venta}}</div>
					</div>
				</div>
			</div>
			...
			<div class="" style="width: 100%;">
					...
					<input rows="5" cols="50" name ="opinion"  style="width: 100%;margin-top: 5px;display: block;padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5;color: #495057;background-color: #fff;background-clip: padding-box;  border: 1px solid #ced4da; border-radius: 0.25rem; transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;" autocomplete="off">{{$detalles->opinion}}
				...
				<div class="f" style="    margin-top: 10px;position: relative;display: block; margin: auto;width: 200px;margin-top: 10px;">
					@if($detalles->valoracion == NULL )
					<button class="" type="submit" style="position: relative;padding: 8px 10px; box-decoration-break: none;border: none;  background: #a305fa;color: #fff;border-radius: 5px; width: 100%;">Guardar</button>
					@else
					<h3 class="" type="submit" style="position: relative;padding: 2px 10px; box-decoration-break: none;border: none;  background: #808080;color: #fff;border-radius: 5px; width: 100%;font-weight: 100;font-family:'Kanit';text-align: center;font-size: 18px ">Valorado</h3>
					@endif
				</div>
