function cambia()
{
  ...
  var sel_departamento = document.getElementsByName("ciudad")[0];
 ...
 ciudad = sel_departamento.options[sel_departamento.selectedIndex].value;


 if(ciudad!=0)
 {
     mis_opts=eval("opt_" + ciudad);
     mis_value=eval("opt_" + ciudad +"_value");
