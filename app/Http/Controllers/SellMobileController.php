...
class SellMobileController extends Controller
{
    ...
    public function index(Request $request){
        ...
        /* Agrupar por if id venta = id detalle */ 
            return view('cell-version.detail-mobile',['venta'=>$venta,'detalles'=>$detalles,'searchText'=>$query ]);
        }
    }
    ...
    public function edit($id){
        ...
        $detalles=DB::table('detalle_venta as d')
            ...
            ->where('v.idpersona','=',$iduser)  
            ->first();
        return view ("cell-version.edit-mobile",["detalles"=>$detalles]);  
    ...
    public function show($id){
        ...
        $detalles=DB::table('detalle_venta as d')
            ...
            ->where('d.idventa','=',$id)
            ->get();
            return view('cell-version.show-mobile',['venta'=>$venta,'detalles'=>$detalles]);
    }
